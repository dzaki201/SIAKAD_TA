<div id="hapus-kepsek-modal-{{ $kepsek->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="hapus-kepsek-modal-{{ $kepsek->id }}">
            ...
            <div class="p-6 space-y-6 text-center">
                <p class="text-gray-700 dark:text-white">Apakah Anda yakin ingin menghapus data Kepala Sekolah ini?</p>
            </div>
            <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                <form action="{{ route('admin.kepsek.destroy', ['id' => $kepsek->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                    ...
                    <button data-modal-hide="hapus-kepsek-modal-{{ $kepsek->id }}" type="button"
