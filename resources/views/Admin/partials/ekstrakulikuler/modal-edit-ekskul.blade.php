<div id="edit-ekskul-modal-{{ $ekskul->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-ekskul-modal-{{ $ekskul->id }}">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.ekskul.update', ['id' => $ekskul->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                    ...
                    <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                        <button type="submit"
                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800">Perbarui</button>
                        <button data-modal-hide="edit-ekskul-modal-{{ $ekskul->id }}" type="button"
