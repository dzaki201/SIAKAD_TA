        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.siswa.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="nis"
                            class="block text-sm font-medium text-gray-700 dark:text-white">Nomor Induk Siswa</label>
                    ...
                    <div class="mb-4">
                        <label for="nama"
                            class="block text-sm font-medium text-gray-700 dark:text-white">Nama Siswa</label>
