<div id="edit-mapel-modal-{{ $mapel->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-mapel-modal-{{ $mapel->id }}">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.mata-pelajaran.update', ['id' => $mapel->id]) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-white mb-2">Pilih Kelas</label>
                            ...
                            @foreach ($kelases as $kelas)
                                <label class="inline-flex items-center space-x-2">
                                    <input type="checkbox" name="kelas_id[]" value="{{ $kelas->id }}"
                                        id="kelas_{{ $kelas->id }}"
                                        {{ in_array($kelas->id, $mapel->kelases->pluck('id')->toArray()) ? 'checked' : '' }}
