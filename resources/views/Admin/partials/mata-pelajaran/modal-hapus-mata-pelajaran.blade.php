<div id="hapus-mapel-modal-{{ $mapel->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="hapus-mapel-modal-{{ $mapel->id }}">
            ...
            <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                <form action="{{ route('admin.mata-pelajaran.destroy', ['id' => $mapel->id]) }}" method="POST">
                    ...
                    <button data-modal-hide="hapus-mapel-modal-{{ $mapel->id }}" type="button"
