<div id="tambah-kkm-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambah-kkm-modal">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.kkm.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="mata_pelajaran_id"
                            class="block text-sm font-medium text-gray-700 dark:text-white">Pilih
                    ...
                    <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                        ...
                        <button data-modal-hide="tambah-kkm-modal" type="button"
