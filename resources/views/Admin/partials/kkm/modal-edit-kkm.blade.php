<div id="edit-kkm-modal-{{ $nilai->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-kkm-modal-{{ $nilai->id }}">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.kkm.update', ['id' => $nilai->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-white">Mata Pelajaran</label>
                        <input type="text" value="{{ $mapels->firstWhere('id', $nilai->mata_pelajaran_id)->nama }}"
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-white">Kelas</label>
                        <input type="text" value="{{ $kelases->firstWhere('id', $nilai->kelas_id)->nama }}"
                            class="w-full px-4 py-2 mt-2 text-sm border border-gray-300 rounded-lg dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                            disabled>
                    ...
                    <div class="mb-4">
                        <label for="nilai" class="block text-sm font-medium text-gray-700 dark:text-white">Niali
                            KKM</label>
                        <input type="number" id="nilai" name="nilai" value="{{ $nilai->nilai }}"
                    ...
                    <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                        ...
                        <button data-modal-hide="edit-kkm-modal-{{ $nilai->id }}" type="button"
