<div id="edit-kelas-modal-{{ $kelas->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-kelas-modal-{{ $kelas->id }}">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.kelas.update', ['id' => $kelas->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                    ...
                    <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                        ...
                        <button data-modal-hide="edit-kelas-modal-{{ $kelas->id }}" type="button"
