<div id="hapus-guru-modal-{{ $guru->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="hapus-guru-modal-{{ $guru->id }}">
            ...
            <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-center">
                <form action="{{ route('admin.guru.destroy', ['id' => $guru->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800">Hapus</button>
                    <button data-modal-hide="hapus-guru-modal-{{ $guru->id }}" type="button"
