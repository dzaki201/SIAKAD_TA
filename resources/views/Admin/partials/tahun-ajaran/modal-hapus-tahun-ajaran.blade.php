<div id="hapus-tahun-ajaran-modal-{{ $tahun->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="hapus-tahun-ajaran-modal-{{ $tahun->id }}">
            ...
            <div class="p-6 space-y-6 text-center">
                <p class="text-gray-700 dark:text-white">Apakah Anda yakin ingin menghapus tahun ajaran ini?</p>
            </div>
            <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                <form action="{{ route('admin.tahun-ajaran.destroy', ['id' => $tahun->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                    ...
                    <button data-modal-hide="hapus-tahun-ajaran-modal-{{ $tahun->id }}" type="button"
