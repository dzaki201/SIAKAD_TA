...
@section('title', 'Kelola Ekstrakulikuler')

@section('content')

    <div class="overflow-x-auto w-auto rounded-lg border p-4 bg-white dark:bg-gray-800 shadow">
        <div class="mb-4">
            <button data-modal-target="tambah-ekskul-modal" data-modal-toggle="tambah-ekskul-modal"
                class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800"
                type="button">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($ekskuls as $ekskul)
                        ...
                        @include('admin.partials.ekstrakulikuler.modal-edit-ekskul')
                        @include('admin.partials.ekstrakulikuler.modal-hapus-ekskul')
                    @endforeach
                </tbody>
            </table>
        </div>
    </div>
    @include('admin.partials.ekstrakulikuler.modal-tambah-ekskul')
