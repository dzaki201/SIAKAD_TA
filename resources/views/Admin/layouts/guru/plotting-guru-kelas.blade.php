...
@section('title', 'Plotting Guru Kelas')
                ...
                <tbody>
                    @foreach ($gurukelases as $guru)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                Guru Kelas {{ $guru->kelas ? $guru->kelas->nama : '' }}
                            </td>
                            <td class="px-6 py-4">
                                <button data-modal-target="edit-plotting-guru-kelas-modal-{{ $guru->id }}"
                                    data-modal-toggle="edit-plotting-guru-kelas-modal-{{ $guru->id }}"
                        ...
                        @include('admin.partials.guru.modal-edit-plotting-guru-kelas')
                    @endforeach
                </tbody>
            </table>
        </div>
    </div>
    @include('admin.partials.guru.modal-plotting-guru-kelas')
@endsection
