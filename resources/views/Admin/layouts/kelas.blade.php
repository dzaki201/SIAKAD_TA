            ...
            <tbody>
                @foreach ($kelases as $kelas)
                    <tr
                        ...
                        <td class="px-6 py-4 ">
                            <button data-modal-target="edit-kelas-modal-{{ $kelas->id }}" data-modal-toggle="edit-kelas-modal-{{ $kelas->id }}"
                            ...
                            <button data-modal-target="hapus-kelas-modal-{{ $kelas->id }}" data-modal-toggle="hapus-kelas-modal-{{ $kelas->id }}"
                    ...
                    @include('admin.partials.kelas.modaleditkelas')
                    @include('admin.partials.kelas.modalhapuskelas')
                @endforeach
            </tbody>
        </table>
    </div>

    @include('admin.partials.kelas.modaltambahkelas')
