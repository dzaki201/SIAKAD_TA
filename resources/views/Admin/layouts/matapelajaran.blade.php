        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr
                    ...
                    <td class="px-6 py-4 ">
                        <button data-modal-target="edit-mapel-modal-{{ $mapel->id }}" data-modal-toggle="edit-mapel-modal-{{ $mapel->id }}"
                        ...
                        <button data-modal-target="delete-mapel-modal-{{ $mapel->id }}" data-modal-toggle="delete-mapel-modal-{{ $mapel->id }}"
