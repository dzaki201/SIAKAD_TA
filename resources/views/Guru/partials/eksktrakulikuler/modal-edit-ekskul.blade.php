        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    Edit nilai Ekstrakulikuler Siswa
                </h3>
                <button type="button" data-modal-hide="edit-ekskul-modal-{{ $ekskul->id }}"
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('guru.ekskul.update', ['id' => $ekskul->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label for="Nama"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="Ekstrakulikuler" name="Ekstrakulikuler"
                            value="{{ $ekskul->ekskul->nama ?? '-' }}"
                            class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                            readonly>
                    </div>
                    <div class="mb-4">
                        <label for="keterangan" class="block mb-1 text-sm font-medium text-gray-700 dark:text-white">
                            Keterangan </label>
