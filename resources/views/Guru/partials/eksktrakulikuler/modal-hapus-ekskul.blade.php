<div id="hapus-ekskul-modal-{{ $ekskul->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="hapus-ekskul-modal-{{ $ekskul->id }}">
            ...
            <div class="p-6 space-y-6 text-center">
                <p class="text-gray-700 dark:text-white">Apakah Anda yakin ingin menghapus data Ekstrakulikuler {{ $ekskul->ekskul->nama ?? '-' }} dari siswa bernama {{ $siswa->nama }} ?</p>
            </div>
            <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                <form action="{{ route('guru.ekskul.destroy', ['id' => $ekskul->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                    ...
                    <button data-modal-hide="hapus-ekskul-modal-{{ $ekskul->id }}" type="button"
