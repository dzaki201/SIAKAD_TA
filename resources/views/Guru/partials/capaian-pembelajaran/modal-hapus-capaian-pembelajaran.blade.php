<div id="hapus-capaian-pembelajaran-modal-{{ $cp->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="hapus-capaian-pembelajaran-modal-{{ $cp->id }}">
            ...
            <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                <form action="{{ route('guru.cp.destroy',['id' => $cp->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                    ...
                    <button data-modal-hide="hapus-capaian-pembelajaran-modal-{{ $cp->id }}" type="button"
