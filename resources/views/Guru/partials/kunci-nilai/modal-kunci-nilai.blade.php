<div id="kunci-nilai-modal-{{ $kunci->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="kunci-nilai-modal-{{ $kunci->id }}">
            ...
            <div class="p-6 space-y-6 text-center">
                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    Apakah Anda yakin ingin <span class="font-semibold text-red-600">mengunci nilai</span> ini?
                    <br>
                    Setelah nilai dikunci, Anda tidak dapat mengisi atau mengedit nilai lagi.
                </p>
            </div>
            <div class="p-6 space-x-4 border-t border-gray-200 dark:border-gray-600 text-right">
                <form action="{{ route('guru.kunci-nilai',['id' => $kunci->id]) }}" method="POST" class="inline">
                    @csrf
                    <button type="submit"
