<div id="catatan-guru-modal-{{ $siswa->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg dark:bg-gray-700">
                    <span class="text-sm font-medium text-gray-900 dark:text-white">Izin:
                        {{ $siswa->absensi->sum('ijin') }}</span>
                    <span class="text-sm font-medium text-gray-900 dark:text-white">Sakit:
                        {{ $siswa->absensi->sum('sakit') }}</span>
                    <span class="text-sm font-medium text-gray-900 dark:text-white">Tanpa Keterangan:
                        {{ $siswa->absensi->sum('alpa') }}</span>
                </div>
